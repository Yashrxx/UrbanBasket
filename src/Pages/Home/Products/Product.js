    ...
    <div className='inventory_products'>
      ...
      <div className="brics">
        <div className="bric-1">
          <div className="br-1">
            <div className="bt-1"><h3>Days</h3></div>
            <div className="bt-2"><h3>Hours</h3></div>
            <div className="bt-3"><h3>Mins</h3></div>
            <div className="bt-4"><h3>Seconds</h3></div>
            <div className="br-12">
              ...
              <div className='pricex1'><strong>$30</strong> <Button className='shopcartButton'><ShoppingCartOutlinedIcon style={{ transform: 'scale(0.8)' }}></ShoppingCartOutlinedIcon>Add</Button></div>
            </div>
          </div>
        </div>
        <div className="bric-1">
